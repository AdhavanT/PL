...
static inline void add_monitoring(MArena* arena)
{
#ifdef MONITOR_ARENA_USAGE
...
static inline void remove_monitoring(MArena* arena)
{
#ifdef MONITOR_ARENA_USAGE
...
#ifdef MONITOR_ARENA_USAGE
	FORCEDINLINE void init_and_allocate(MArena* arena, uint32 no_of_elements, const char* _name)
	{
		size = no_of_elements;
		name = (char*)_name;
		ASSERT(front == 0);
